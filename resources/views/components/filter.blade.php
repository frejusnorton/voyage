<div class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden opacity-0 transition-opacity duration-200"
    id="filterModal">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md transform transition-all duration-200 translate-y-4"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number"
                                ...
                                id="montant" name="montant" min="1000" max="50000" step="500"
