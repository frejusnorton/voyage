        ...
        <div class="mb-13">
            ...
            <div class="mb-15">
                ...
                <p class="fw-semibold fs-4 text-gray-600 mb-2">
                    Notre plateforme met en relation des conducteurs et des passagers souhaitant partager un trajet. Le
                    conducteur publie une annonce avec les détails du voyage, et les passagers peuvent réserver une
                    place directement en ligne.
                </p>
                <!--end::Text-->
            </div>
            <!--end::Intro-->
                    ...
                    <div class="m-0">
                        ...
                        <div id="kt_job_6_1" class="collapse show fs-6 ms-1">
                            ...
                            <div class="mb-4 text-gray-600 fw-semibold fs-6 ps-10">
                                Oui, un compte est nécessaire pour contacter les conducteurs ou réserver un trajet.
                                L'inscription est gratuite et ne prend que quelques minutes. </div>
                            <!--end::Text-->
                        </div>
                        <!--end::Content-->
                ...
                <div class="col-md-6 ps-md-10">
                    ...
                    <div class="m-0">
                        ...
                        <div id="kt_job_7_2" class="collapse  fs-6 ms-1">
                            <!--begin::Text-->
                            <div class="mb-4 text-gray-600 fw-semibold fs-6 ps-10">
                                Les conducteurs définissent leurs propres tarifs dans une fourchette raisonnable basée
                                sur la distance du trajet. La plateforme peut proposer des suggestions pour assurer des
                                prix équitables.
                            </div>
                            <!--end::Text-->
                        </div>
                    ...
                    <div class="m-0">
                        <!--begin::Heading-->
                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0 active"
                            data-bs-toggle="collapse" data-bs-target="#kt_job_7_3" aria-expanded="true">
                            <!--begin::Icon-->
                            <div class="btn btn-sm btn-icon mw-20px btn-active-color-primary me-5">
                                <i class="ki-duotone ki-minus-square toggle-on text-primary fs-1"><span
                                        class="path1"></span><span class="path2"></span></i>
                        ...
                        <!--begin::Body-->
                        <div id="kt_job_7_3" class="fs-6 ms-1 collapse show" style="">
                            <!--begin::Text-->
                            <div class="mb-4 text-gray-600 fw-semibold fs-6 ps-10">
                                Non, le prix affiché est le prix final. Aucun frais caché ne sera ajouté à votre
                                réservation.
