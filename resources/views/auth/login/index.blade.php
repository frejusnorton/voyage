...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12  px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form id="login-form" class="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-lg" method="post"
                action="{{ route('login') }}">
                @csrf
                ...
                <div>
                    <a href="{{ route('redirectToGoogle') }}"
                        class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition duration-300">
                        ...
                        <button type="button" @click="show = !show"
                            ...
                            <svg x-show="show" class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19
                                    ...
                                    a9.958 9.958 0 013.112-4.568m3.236-1.768
                                    A9.956 9.956 0 0112 5c4.477 0 8.268 2.943
                                    9.542 7a9.961 9.961 0 01-4.117 5.302M15 12
                ...
                <div class="relative w-full flex justify-center items-center">
                    <button type="submit" id="kt_sign_in_submit"
                        class="group w-full flex justify-center items-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 relative">
