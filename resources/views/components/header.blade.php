		...
		<div class="flex justify-between items-center py-4">
			...
			<div class="flex items-center space-x-4">
				<div class="relative">
					<button onclick="toggleUserMenu()"
						...
						@auth
							@if(Auth::user()->profil_img)
								<img src="{{ Auth::user()->profil_img  }}" alt="Profil"
					...
					<div id="userMenu"
						class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl py-2 hidden transform transition-all duration-300 ease-in-out opacity-0 scale-95">
						@guest
							<a href="{{ route('login') }}"
						...
						@auth
							@if(Auth::user()->type === 'passager')
								<span>
									<a href="{{ route('passager.index', Auth::user()->id) }}"
						...
						@endauth
							...
							<div class="relative group">
								<button
									class="w-full text-left px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition flex items-center justify-between">
								...
								<div
									class="absolute left-0 mt-1 w-full bg-white rounded-lg shadow-lg py-2 hidden group-hover:block z-10">
									<span
										class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition flex items-center">
				...
				<button onclick="toggleMobileMenu()"
					class="text-2xl text-gray-700 hover:text-blue-600 transition lg:hidden">
...
<div id="mobileMenu" class="fixed inset-0 bg-black bg-opacity-60 z-40 hidden ">
	<div
		class="fixed inset-y-0 right-0 w-64 bg-white transform transition-transform duration-300 ease-in-out translate-x-full">
